...
import org.killbill.billing.plugin.amberflo.catalog.core.CatalogTestHealthcheck;
import org.killbill.billing.plugin.core.resources.PluginHealthcheck;
import org.killbill.billing.tenant.api.Tenant;

@Singleton
@Path("/healthcheck")
public class CatalogTestHealthcheckServlet extends PluginHealthcheck {

  private final CatalogTestHealthcheck healthcheck;

  @Inject
  public CatalogTestHealthcheckServlet(final CatalogTestHealthcheck healthcheck) {
